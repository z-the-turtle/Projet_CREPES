...
**- 1 - Modèle 1D sans échanges thermiques.py :**
    ...
    Représenation de 18 blocs faisant chacun 2000 km sont représentés. Le vent va à 10m/s, donc à chaque fois qu'un bloc prend la place du bloc à sa droite il s'est passé 55h30.
